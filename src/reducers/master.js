...
export default function master(state = initialState, action) {
    switch (action.type) {
        ...
        case STATUS_PROYEK_SAVE:
            return {
                ...state,
                [STATUS_PROYEK]: action.payload
            };
        case STATUS_PROYEK_RESET:
            return {
                ...state,
                [STATUS_PROYEK]: '01'
            }; 
