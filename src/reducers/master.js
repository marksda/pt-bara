...
const initialState = {
    ...
    mode_pengajuan_baru: 'add',
    mode_proyek_baru: 'add',
    item_pengajuan_selected: null,
    item_proyek_selected: null,
    item_transaksi_selected: null,
    ...
    filter_jenis_transaksi: null,
    pagination_jenis_transaksi: {
        current: 1,
        pageSize: 50,
    },
    urut_jenis_transaksi: {
        field: "m.nama",
        order: "asc"
    },
    list_transaksi: null,
    filter_transaksi: null,
    pagination_transaksi: {
        current: 1,
        pageSize: 100,
    },
    urut_transaksi: {
...
export default function master(state = initialState, action) {
    switch (action.type) {
        ...
        case STATUS_PROYEK_SELECTED_RESET:
            ...
            break;
        case MODE_PENGAJUAN_BARU_LOADED:
            return {
                ...state,
                [MODE_PENGAJUAN_BARU]: action.payload
            }; 
            break;
        case MODE_TRANSAKSI_BARU_LOADED:
            return {
                ...state,
                [MODE_TRANSAKSI_BARU]: action.payload
            }; 
            break;
        ...
        case ITEM_MENU_SELECTED_LOADED:
            ...
            break;
        case ITEM_PENGAJUAN_SELECTED_LOADED:            
            return {
                ...state,
                [ITEM_PENGAJUAN_SELECTED]: action.payload
            }; 
            break;
        case ITEM_PENGAJUAN_SELECTED_RESET:
            return {
                ...state,
                [ITEM_PENGAJUAN_SELECTED]: null
            }; 
        ...
        case URUT_PENGAJUAN_RESET:
            ...
            break; 
        case JENIS_TRANSAKSI_LOADED:
            return {
                ...state,
                [JENIS_TRANSAKSI]: action.payload
            };  
        case JENIS_TRANSAKSI_RESET:
            return {
                ...state,
                [JENIS_TRANSAKSI]: null
            };      
        case PAGINATION_JENIS_TRANSAKSI_LOADED:
            return {
                ...state,
                [PAGINATION_JENIS_TRANSAKSI]: {...action.payload}
            };
        case PAGINATION_JENIS_TRANSAKSI_RESET:
            let tmpPaginationJENIS_TRANSAKSI = {
                current: 1,
                pageSize: 50,
            }
            return {
                ...state,
                [PAGINATION_JENIS_TRANSAKSI]: {...tmpPaginationJENIS_TRANSAKSI}
            };
        case URUT_JENIS_TRANSAKSI_LOADED:
            return {
                ...state,
                [URUT_JENIS_TRANSAKSI]: action.payload
            };
        case URUT_JENIS_TRANSAKSI_RESET:
            let tmpUrutJENIS_TRANSAKSI = {
                field: "m.nama",
                order: "asc"
            }
            return {
                ...state,
                [URUT_JENIS_TRANSAKSI]: {...tmpUrutJENIS_TRANSAKSI}
            };   
            break;             
        case FILTER_JENIS_TRANSAKSI_LOADED:
            return {
                ...state,
                [FILTER_JENIS_TRANSAKSI]: action.payload
            };
        case FILTER_JENIS_TRANSAKSI_RESET:
            return {
                ...state,
                [FILTER_JENIS_TRANSAKSI]: null
            };
        case IS_PROGRESS_SET:        
            ...
            break;  
        case FILTER_TRANSAKSI_LOADED:
            return {
                ...state,
                [FILTER_TRANSAKSI]: action.payload
            };
        case FILTER_TRANSAKSI_RESET:
            return {
                ...state,
                [FILTER_TRANSAKSI]: null
            };
        case LIST_TRANSAKSI_LOADED:
            return {
                ...state,
                [LIST_TRANSAKSI]: action.payload
            };  
        case LIST_TRANSAKSI_RESET:
            return {
                ...state,
                [LIST_TRANSAKSI]: null
            };      
        case PAGINATION_TRANSAKSI_LOADED:
            return {
                ...state,
                [PAGINATION_TRANSAKSI]: {...action.payload}
            };
        case PAGINATION_TRANSAKSI_RESET:
            let tmpPaginationTRANSAKSI = {
                current: 1,
                pageSize: 100,
            }
            return {
                ...state,
                [PAGINATION_TRANSAKSI]: {...tmpPaginationTRANSAKSI}
            };
        case URUT_TRANSAKSI_LOADED:
            return {
                ...state,
                [URUT_TRANSAKSI]: action.payload
            };
        case URUT_TRANSAKSI_RESET:
            let tmpUrutTRANSAKSI = {
                field: "m.tanggal",
                order: "asc"
            }
            return {
                ...state,
                [URUT_TRANSAKSI]: {...tmpUrutTRANSAKSI}
            };    
        case ITEM_TRANSAKSI_SELECTED_LOADED:            
            return {
                ...state,
                [ITEM_TRANSAKSI_SELECTED]: action.payload
            }; 
            break;
        case ITEM_TRANSAKSI_SELECTED_RESET:
            return {
                ...state,
                [ITEM_TRANSAKSI_SELECTED]: null
            }; 
